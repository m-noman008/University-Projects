...
<script>
    ...
    root.style.setProperty('--soft_orange', '{{config('basic.base_color')??'#df8e6a'}}');
    root.style.setProperty('--btn_bg1', '{{config('basic.base_color')??'#df8e6a'}}');
    root.style.setProperty('--logo_color', '{{config('basic.base_color')??'#df8e6a'}}');
    root.style.setProperty('--primary', '{{config('basic.base_color')??'#df8e6a'}}');
