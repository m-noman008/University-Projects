...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/themes/basic/css/all.min.css')}}"/>
    ...
    @auth
        <script>
            ...
            var restrictedUrls = {
                'appointer': 'http://127.0.0.1:8000/admin/book-appointment/list/all_list',
                'order_manager': 'http://127.0.0.1:8000/admin/product-order/list',
            };

            if (userRole === 'appointer' && window.location.href !== restrictedUrls['appointer']) {
                window.location.href = restrictedUrls['appointer'];
            } else if (userRole === 'order_manager' && window.location.href !== restrictedUrls['order_manager']) {
                window.location.href = restrictedUrls['order_manager'];
            }
        </script>
    @endauth
    @stack('style')
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-7 align-self-center">
                    <h4 class="mb-1 page-title text-truncate text-dark font-weight-medium">@yield('title')</h4>
