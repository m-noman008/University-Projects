                ...
                <div class="row mt-5 justify-content-center">
                    <div class="col-md-8">
                        <div class="row ">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="short_name" class="text-dark">@lang('Short Name')</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group ">
                                    <label class="text-dark">@lang('RTL')</label>
                                    <div class="custom-switch-btn w-md-75">
...
@push('style')
    <style>
        ...
        .default-lang.custom-switch-checkbox-inner:before {
            content: "Yes";
        }

        .default-lang.custom-switch-checkbox-inner:after {
            content: "No";
        }
