            ...
            <div class="mt-2 tab-content" id="myTabContent">
                @foreach ($languages as $key => $language)
                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-tab-{{ $key }}"
                        role="tabpanel">
                        <form method="post" action="{{ route('admin.team.update', [$id, $language->id]) }}" class="mt-4"
                            ...
                            <div class="row">
                                <div class="mb-3 col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="name[{{ $language->id }}]"
                                        ...
                                        value="<?php echo old('name' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->name : ''); ?>" autocomplete="off">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    ...
                                    <input type="email" name="email[{{ $language->id }}]"
                                        ...
                                        value="<?php echo old('email' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->email : ''); ?>" autocomplete="off">
                                    <div class="invalid-feedback">
                                ...
                                @if ($loop->index == 0)
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <input type="text" name="phone"
                                            ...
                                            value="<?php echo old('phone' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->team->phone : ''); ?>" autocomplete="off">
                                        <div class="invalid-feedback">
                                            @error('phone')
                                                @lang($message)
                                            @enderror
                                ...
                                <div class="col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="position[{{ $language->id }}]"
                                        ...
                                        value="<?php echo old('position' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->position : ''); ?>" autocomplete="off">
                                    <div class="invalid-feedback">
                                ...
                                @if ($loop->index == 0)
                                    <div class="mt-2 col-sm-12 col-md-6">
                                        ...
                                        <input type="text" name="experience"
                                            ...
                                            value="<?php echo old('experience' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->team->experience : ''); ?>" autocomplete="off">
                                        @error('experience')
                                    ...
                                    <div class="mt-2 col-sm-12 col-md-6">
                                        ...
                                        <input type="text" name="level"
                                            ...
                                            value="<?php echo old('level' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->team->level : ''); ?>" autocomplete="off">
                                        @error('level')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="mt-2 col-sm-12 col-md-6">
                                        ...
                                        <input type="text" name="facebook_link"
                                            ...
                                            value="<?php echo old('facebook_link' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->team->facebook_link : ''); ?>" autocomplete="off">
                                        @error('facebook_link')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="mt-2 col-sm-12 col-md-6">
                                        ...
                                        <input type="text" name="twitter_link"
                                            ...
                                            value="<?php echo old('twitter_link' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->team->twitter_link : ''); ?>" autocomplete="off">
                                        @error('twitter_link')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="mt-2 col-sm-12 col-md-6">
                                        ...
                                        <input type="text" name="linkedin_link"
                                            ...
                                            value="<?php echo old('linkedin_link' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->team->linkedin_link : ''); ?>" autocomplete="off">
                                        @error('linkedin_link')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="mt-2 col-sm-12 col-md-6">
                                        ...
                                        <input type="text" name="skype_link"
                                            ...
                                            value="<?php echo old('skype_link' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->team->skype_link : ''); ?>" autocomplete="off">
                                        @error('skype_link')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="mt-2 col-sm-12 col-md-12">
                                    ...
                                    <input type="text" name="staffpassword" value="<?php echo old('staffpassword' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->team->staffpassword : ''); ?>" class="form-control" autocomplete="off">
                                </div>
                                <div class="my-3 col-sm-12 col-md-12">
                                    <div class="form-group ">
                                        ...
                                        <textarea class="form-control @error('short_description' . '.' . $language->id) is-invalid @enderror"
                                            name="short_description[{{ $language->id }}]" rows="5" value="<?php echo old('short_description' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->short_description : ''); ?>"><?php echo old('short_description' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->short_description : ''); ?></textarea>
                                        <div class="invalid-feedback">
                                ...
                                <div class="my-3 col-sm-12 col-md-12">
                                    <div class="form-group ">
                                        ...
                                        <textarea class="form-control summernote @error('biography' . '.' . $language->id) is-invalid @enderror"
                                            name="biography[{{ $language->id }}]" id="summernote" rows="15" value="<?php echo old('biography' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->biography : ''); ?>"><?php echo old('biography' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->biography : ''); ?></textarea>
                                        <div class="invalid-feedback">
                                ...
                                <div class="my-3 col-sm-12 col-md-12">
                                    <div class="form-group ">
                                        ...
                                        <textarea class="form-control summernote @error('working_process' . '.' . $language->id) is-invalid @enderror"
                                            ...
                                            value="{{ old('working_process' . '.' . $language->id) }}"><?php echo old('working_process' . $language->id, isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->my_working_process : ''); ?></textarea>
                                        <div class="invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="image-input ">
                                                ...
                                                <img id="image_preview_container" class="preview-image"
                                                    src="{{ getFile(config('location.team.path') . (isset($teamDetails[$language->id]) ? @$teamDetails[$language->id][0]->team->image : '')) }}"
                                                    alt="@lang('preview image')">
                                            </div>
                                            @if (config('location.team.path'))
                                                <span class="mb-2 text-muted">{{ trans('Image size should be') }}
                                                    {{ config('location.team.size') }} {{ trans('px') }}</span>
                                            @endif
                                            @error('image')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-lg-2 col-md-6">
                                        <div class="form-group">
                                            <a href="javascript:void(0)" class="float-right mt-3 btn btn-success"
                                                id="generate"><i class="fa fa-plus-circle"></i> @lang('Add Top Skills')</a>
                                        </div>
                                    </div>
                                </div>

                                <div class="row addedField">
                                    @if ($teamDetails[$language->id][0]->team->top_skills)
                                        @foreach ($teamDetails[$language->id][0]->team->top_skills as $data)
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input name="skill_percentage[]" class="form-control "
                                                            type="number" value="{{ $data->field_value }}" required
