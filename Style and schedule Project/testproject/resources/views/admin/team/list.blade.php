    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            <div class="media mb-4 float-right">
                <a href="{{ route('admin.team.create') }}" class="btn btn-sm btn-primary mr-2">
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Name')">
                                    <div class="d-lg-flex d-block align-items-center ">
                                        ...
                                        <div class="">
                                            <span class="text-muted font-14">@lang(optional($item->teamDetails)->name)</span>
                                        </div>
                                    </div>
                                </td>
                                <td data-label="@lang('Action')">
                                    ...
                                    <a href="javascript:void(0)" data-route="{{ route('admin.team.delete', $item->id) }}"
