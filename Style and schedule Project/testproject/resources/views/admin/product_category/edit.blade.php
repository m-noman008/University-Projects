    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            <div class="media mb-4 justify-content-end">
                <a href="{{ route('admin.product.category.list') }}" class="btn btn-sm  btn-primary mr-2">
            ...
            <div class="tab-content mt-2" id="myTabContent">
                @foreach ($languages as $key => $language)
                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-tab-{{ $key }}"
                        role="tabpanel">
                        <form method="post" action="{{ route('admin.product.category.update', [$language->id, $id]) }}"
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 mb-3">
                                    ...
                                    <div class="invalid-feedback">
                                        @error('category_name' . '.' . $language->id)
                                            @lang($message)
                                        @enderror
                                    </div>
