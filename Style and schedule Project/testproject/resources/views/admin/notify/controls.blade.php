        ...
        <div class="col-md-5">
            <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
                <div class="card-header text-white py-3 d-flex flex-row align-items-center justify-content-between">
                    <h4 class="text-dark font-weight-bold">@lang('Instructions')</h4>
                    <a href="https://www.youtube.com/watch?v=MQszEDuWFeQ" target="_blank" class="btn btn-primary btn-sm mb-2 text-white float-right" type="button">
